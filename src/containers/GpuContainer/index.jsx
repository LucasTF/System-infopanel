	...
	const buildHwObject = hw => {
		...
		const relHw = {
			model: {
				...
				colorTheme: color,
				size: 3,
				information: hw.controllers[0].model,
			},
			manufacturer: {
				title: 'Manufacturer',
				visible: true,
				...
				colorTheme: color,
				size: 1,
				information: hw.controllers[0].vendor,
			},
			vram: {
				title: 'VRAM',
				...
				colorTheme: color,
				size: 1,
				information: `${hw.controllers[0].vram} MB`,
			},
			displayres: {
				...
				colorTheme: color,
				size: 1,
				information: `${hw.displays[0].resolutionx}x${hardware.displays[0].resolutiony}`,
			},
			refresh: {
				title: 'Refresh Rate',
				visible: true,
				colorTheme: color,
				size: 1,
				information: `${hw.displays[0].currentRefreshRate}hz`,
			},
			connector: {
				title: 'Connector',
				visible: true,
				colorTheme: color,
				size: 1,
				information: hw.displays[0].connection,
			},
		};
		return relHw;
	};
